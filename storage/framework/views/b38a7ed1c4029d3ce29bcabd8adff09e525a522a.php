                                        ...
                                        <div class="container">
                                            <div class="row" style="background-color: white; opacity: 0.8; height: auto"><br>
                                                <div class="col-md-10 col-md-offset-1">
                                                    <?php if(Auth::user()): ?>
                                                        <div class="col-md-4">
                                                            <p style="color: darkgrey; font-weight: bold">سعر الخدمة بالريال : <?php echo e($service_requirements->price == 0 ? 'غير محدد' : $service_requirements->price); ?></p><br>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <p style="color: darkgrey; font-weight: bold">رقم الحساب : <?php echo e($service_requirements->bank_account); ?></p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <p style="color: darkgrey; font-weight: bold">اسم البنك : <?php echo e($service_requirements->bank_name); ?></p>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <?php if(Auth::user()): ?>
                                                            <?php if($service_requirements->bank_name !== 'غير محدد' || $service_requirements->bank_account !== 'غير محدد' || $service_requirements->customer_name !== 'غير محدد' || $service_requirements->price != 0): ?>
...
</html><?php /**PATH E:\My Desktop\Sarah\Projects\govoiceo_project\resources\views/request_service.blade.php ENDPATH**/ ?>