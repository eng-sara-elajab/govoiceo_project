...
<?php $__env->startSection('content'); ?>
    <div class="card animate-box" style="opacity: 0.7; margin-top: 5%; height: auto">
        ...
        <form action="/admin/update_invoice/<?php echo e($invoice->id); ?>" method="post" style="width: 80%; margin: auto" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-12">
                ...
                <img src="/images/invoices/<?php echo e($invoice->subscription_invoice); ?>" style="height: 300px; width: 100%"><br><br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/admin/edit_invoice.blade.php ENDPATH**/ ?>