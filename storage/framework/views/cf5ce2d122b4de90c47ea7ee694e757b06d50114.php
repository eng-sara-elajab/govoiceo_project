...
unset($__errorArgs, $__bag); ?>" placeholder="البريد الإلكتروني" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" style="font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid">
...
unset($__errorArgs, $__bag); ?>" placeholder="كلمة المرور" name="password" required autocomplete="new-password" style="font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid">
...
</html><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/auth/login.blade.php ENDPATH**/ ?>