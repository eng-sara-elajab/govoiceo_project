...
<html>
    ...
    <body style="background-image:  url(<?php echo e(asset('images/man_using_laptop.jpg')); ?>);
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div class="container-fluid">
                <a href="#" style="text-align: center">
                    <img src="<?php echo e(asset('/images/logos/'.$website_data->logo)); ?>" class="img-circle img-responsive" style="width: 30%; height: 5%; margin-left: 30%">
                    <span class="brand-text font-weight-light" style="font-size: large"><?php echo e($website_data->name); ?></span>
                </a>
                ...
                <div class="nav-item">
                    <a href="/admin/user_service_requests" class="pull-right">
                        <h3 style="font-weight: bold"><i class="fa fa-circle nav-icon pull-right" style="color: orange"></i>
                            <?php if(count($new_services) > 0): ?>
                                    <span class="badge badge-warning pull-left"><?php echo e(count($new_services)); ?></span>&nbsp;&nbsp;&nbsp;
                                <?php endif; ?>
                        طلبات الخدمات &nbsp;
                        </h3>
                    </a>
                ...
                <?php if($permission->email == 'admin@example.com'): ?>
                    <div class="nav-item">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-block" style="color: orange"><i class="fa fa-sign-out nav-icon" style="color: orange" aria-hidden="true"></i>&nbsp;تسجيل الخروج</a>
                </div>
            </div>
        </div>
    </body>
</html>
<?php /**PATH E:\My Desktop\Sarah\Projects\govoiceo_project\resources\views/home.blade.php ENDPATH**/ ?>