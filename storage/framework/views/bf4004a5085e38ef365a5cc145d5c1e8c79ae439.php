                            ...
                            <div id="fh5co-project">
                                <div class="row">
                                    <div class="col-md-12 container-fluid proj-bottom">
                                        ...
                                        <?php endif; ?>
                                        <iframe width="80%" height="390" src="<?php echo e(asset('/videos/courses/'.$course->video)); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                                        <div class="row">
                                            <div class="col-md-6 pull-right">
                                                <h1 style="color: white; font-weight:bold"><?php echo e($course->name); ?></h1>
                                            </div>
                                            <div class="col-md-6 pull-left">
                                                <h3 style="color: white; font-family: Areeq Al-Gafelh"><span style="color: orange; font-size: 16px">SAR</span>السعر: <?php echo e($course->price); ?><h3>
                                            </div>
                                            <?php if($course->introduction != null): ?>
                                                <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <?php if(Auth::user()): ?>
                                                    <?php if($course->price == 'free'): ?>
                                                        <a class="btn btn-lg btn-primary popup-vimeo" href="<?php echo e($course->course_link); ?>" style="text-align: center; margin-top: 10px">إضغط لمشاهدة الكورس كاملاً</a>
                                                    <?php else: ?>
                                                        <?php if(in_array($course->id, $subscribed_courses)): ?>
                                                            <a class="btn btn-lg btn-primary <?php echo e(in_array($course->id, $subscribed_courses) ?  'popup-vimeo' : ''); ?>" href="<?php echo e($course->course_link); ?>" style="text-align: center; margin-top: 10px">إضغط لمشاهدة الكورس كاملاً</a>
                                                        <?php else: ?>
                                                            <a class="btn btn-lg btn-primary <?php echo e(in_array($course->id, $subscribed_courses) ?  'popup-vimeo' : ''); ?>" href="/subscribe/<?php echo e($course->id); ?>" style="text-align: center; margin-top: 10px">إضغط لمشاهدة الكورس كاملاً</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                <?php else: ?>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8 col-md-pull-1 animate-box">
                                    <img class="img-responsive" src="/images/courses/<?php echo e($course->image); ?>" style="width: 95%; height: 70%; margin-left: 10px" alt="work">
                                </div>
                                <div class="col-md-3 animate-box"><br><br><br><br>
                                    <h3 style="color: white; font-weight: bold; text-align: center"><?php echo e($course->name); ?></h3>
                                    <p><a class="btn btn-primary btn-lg btn-video" style="color: white; font-weight: bold; text-align: center" href="/one_course/<?php echo e($course->id); ?>"><i class="icon-play"></i>اضغط للحصول على الفيديو التعريفي </a></p>
                                </div>
                            </div>
                        </div>
                    </div><br><br><br>
...
</html><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/one_course.blade.php ENDPATH**/ ?>