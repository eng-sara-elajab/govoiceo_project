                                        ...
                                        <div class="container">
                                            <div class="row" style="background-color: white; opacity: 0.8; height: auto"><br>
                                                <div class="col-md-12 animate-box">
                                                    ...
                                                    <form action="/submit_subscription/<?php echo e($id); ?>" method="post" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <?php $__errorArgs = ['subscription_invoice'];
...
</html><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/subscription_form.blade.php ENDPATH**/ ?>