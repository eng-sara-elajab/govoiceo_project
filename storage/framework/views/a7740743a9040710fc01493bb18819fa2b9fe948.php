        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div class="container-fluid">
                <a href="#" style="text-align: center">
                    <img src="<?php echo e(asset('images/logos/'.$website_data->logo)); ?>" class="img-circle img-responsive" style="width: 30%; height: 10%; margin-left: 30%">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-block" style="color: orange"><i class="fa fa-sign-out" style="color: orange" aria-hidden="true"></i>&nbsp;تسجيل الخروج</a>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/layouts/admin.blade.php ENDPATH**/ ?>