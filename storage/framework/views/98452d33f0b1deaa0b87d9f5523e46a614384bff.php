        ...
        <div class="col-md-10 col-md-offset-1 animate-box" style="margin-top: 3%">
            ...
            <form action="/admin/profile" method="post">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <input type="text" id="right_placeholder" style="text-align: right; font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid" class="form-control" name="name" value="<?php echo e($admin->name); ?>" required>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-12">
                        <input type="email" id="right_placeholder" style="font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid" class="form-control" name="email" value="<?php echo e($admin->email); ?>" required>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u229186696/domains/govoiceo.com/blog/resources/views/admin/profile.blade.php ENDPATH**/ ?>