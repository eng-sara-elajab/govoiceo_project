                                        ...
                                        <div class="container">
                                            <div class="row" style="background-color: white; opacity: 0.8; height: auto"><br>
                                                <div class="col-md-3 col-md-offset-1 animate-box">
                                                    ...
                                                    <div class="fh5co-contact-info">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="phone"><a href="tel://1234567920">{{$website_data->phone}}</a></li>
                                                ...
                                                <div class="col-md-7 col-md-offset-1 animate-box">
                                                    ...
                                                    <h4 style="color: darkorange; font-weight: bold">{{$edit_service->reject_message}}</h4>
                                                    <form action="/update_service/{{$edit_service->id}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        {{method_field('put')}}
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="text" id="right_placeholder" class="form-control" style="height: 50px; width: 100%; border-radius: 15px; border: 2px thin" name="text_load" value="{{$edit_service->inserted_text}}" placeholder="صوت النص">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <input type="text" id="right_placeholder" class="form-control" style="height: 50px; width: 100%; border-radius: 15px; border: 2px thin" name="music_type" value="{{$edit_service->music_type}}" placeholder="إذا كان مع مونتاج حدد نوع الموسيقى">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
