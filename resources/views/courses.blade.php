                                        ...
                                        @if(count($courses) > 0)
                                            @foreach($courses as $course)
                                                <div class="card col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn" style="width: 350px; height: 300px">
                                                    <div class="card-body">
                                                        <a href="/one_course/{{$course->id}}"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzvGaNeK4CbtCIG_6pQMUYMK94Lmc4NEbClA&usqp=CAU" style="width: 350px; height: 200px" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
