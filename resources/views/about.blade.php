                                            ...
                                            <div class="row" style="background-color: white; opacity: 0.8"><br>
                                                <div class="row">
                                                    <div class="col-md-3 col-md-offset-1">
                                                        <img src="{{asset('/images/logos/'.$website_data->logo)}}" class="img-circle img-responsive" style="width: 100%; height: 100%; border-radius: 50%"><br>
                                                        <div class="fh5co-contact-info">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="email"><a href="{{$website_data->email}}" target="_blank">{{$website_data->email}}</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
                                                        @if($website_data->about_text == 'شرح كامل عن الموقع والجهة المؤسسة هنا')
                                                            <br><br><br><br><br><br><br><br><br>
                                                            <h1 style="color: darkorange; text-align: right">{{$website_data->about_text}}</h1>
                                                        @else
