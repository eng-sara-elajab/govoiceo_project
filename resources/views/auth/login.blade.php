                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-4 text-right menu-1">
                                        <ul>
                                            ...
                                            @else
                                                <li class="btn-cta active"><a href="/login"><span>تسجيل الدخول</span></a></li>
                                ...
                                <div class="container-fluid proj-bottom">
                                    <div id="fh5co-contact">
                                        <div class="container"><br><br>
                                            ...
                                            @endif
                                            <div class="row" style="background-color: white; opacity: 0.7; border: 2px solid lightgrey; height: 350px"><br>
                                                <div class="col-md-10 col-md-offset-1 animate-box">
                                                    <h4 style="color: darkorange; font-weight: bold; text-align: center">الرجاء إدخال البريد الإلكتروني وكلمة السر</h4><br>
                                                    <form method="POST" action="{{ route('login') }}">
                                                        @csrf
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <!-- <label for="email">Email</label> -->
                                                                <input type="email" id="right_placeholder" class="form-control @error('email') is-invalid @enderror" placeholder="البريد الإلكتروني" name="email" value="{{ old('email') }}" required autocomplete="email" style="font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid">
                                                                @error('email')
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="password" id="right_placeholder" class="form-control @error('password') is-invalid @enderror" placeholder="كلمة المرور" name="password" required autocomplete="new-password" style="font-size: 20px; height: 50px; background-color: white; opacity: 0.9; border-radius: 15px; border: 2px solid">
                                                                @error('password')
                                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <input type="submit" value="دخول" class="btn btn-primary" style="width: 200px">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
